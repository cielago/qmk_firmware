...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = KEYMAP(
      ...
      LSFT_T(KC_ESCAPE), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
      MO(2),               KC_LALT,    KC_LGUI,    KC_ENT,    KC_SPC,        KC_SPC, KC_APP,  MO(1)
      ),
  [1] = KEYMAP(
  ...
  [2] = KEYMAP(
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_MS_WH_LEFT,    KC_MS_WH_UP,    KC_MS_WH_DOWN,    KC_MS_WH_RIGHT,    KC_0,    KC_EQL,  KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MS_BTN1, KC_TRNS, KC_MS_LEFT, KC_MS_UP, KC_MS_DOWN, KC_MS_RIGHT,   KC_TRNS, KC_TRNS,
      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS,
      RGB_MOD, BL_TOGG, KC_LGUI, KC_LSFT, KC_SPC,  KC_SPC,  KC_APP,  KC_TRNS
      ),    
};
